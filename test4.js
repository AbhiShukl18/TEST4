...
// const string=["Abhishek", "Abhi","Rudra", "Rudransh", "Shiv"];
//  const result=[];
...
// Question 9:Create a JavaScript program that generates a random password of a specified length, consisting of letters (both uppercase and lowercase), numbers, and special characters.
